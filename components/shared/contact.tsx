  ...
  const contactlinks = [
    {
      ...
      href: "https://www.linkedin.com/in/bayo-adedeji-817b59205/",
    },
    {
      title: "GitHub",
      icon: (
    ...
    },
    {
      ...
      href: "mailto:abayo4141@gmail.com",  // Replace with your actual email
    },
    {
      title: "Twitter",
      icon: (
    ...
    <div id="contact" className="hover:cursor-pointer lg:px-40 sm:px-9 py-8 mt-14">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center">
        <div className="mb-4 sm:mb-0">
          ...
          <Link href="mailto:abayo4141@gmail.com">
            <span className="text-xl hover:underline">abayo4141@gmail.com</span>
          </Link>
        </div>
      ...
      <footer className="mt-10 text-center">
        <hr />
        <br />
        <span className="font-light text-sm text-gray-600">Copyright  2024 - Adedeji Bayo.</span>
