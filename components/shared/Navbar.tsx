                ...
                <nav aria-label="Global" className="bg-white flex items-center justify-between p-5 xl:px-36">
                    <div className="flex lg:flex-1">
                        ...
                        <Link href="/" className="-m-1.5 p-1.5">
                            <h1 className='font-extrabold text-xl text-black font-sans'>Adedeji<span className='text-yellow-400 font-bold'> Bayo</span></h1>
                        </Link>
                    </div>
                    ...
                    <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
                        <div className="flex items-center justify-between">
                            ...
                            <Link href="/" className="-m-1.5 p-1.5">
                                ...
                                <h1 className='font-extrabold text-slate-950'>Adedeji<span className='font-extrabold text-yellow-400'> Bayo</span></h1>
                            </Link>
